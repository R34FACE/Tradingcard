...
const TEMPLATE_LAYOUT = {
  character: {
    R: {
      ...
      stats: {
        hp: { x: 255, y: 955, maxWidth: 120, fontSize: 38, align: "right", color: "#fff7e0", weight: 900 },
        atk: { x: 255, y: 1040, maxWidth: 120, fontSize: 38, align: "right", color: "#fff7e0", weight: 900 },
        def: { x: 255, y: 1110, maxWidth: 120, fontSize: 38, align: "right", color: "#fff7e0", weight: 900 },
        spd: { x: 255, y: 1180, maxWidth: 120, fontSize: 38, align: "right", color: "#fff7e0", weight: 900 }
      },
      skill1: {
        nameX: 410,
        nameY: 1034,
